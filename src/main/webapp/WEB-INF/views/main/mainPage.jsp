...
<html>
<head lang="en">
<title>Angular Spring Api Starte</title>
<meta charset="utf-8" />
...
<body ng-app="app">
	...
	<c:set var="springApiBasePath" value="https://rawgit.com/ArslanAnjum/angularSpringApi/master/src/main/resources/static/webResources/js/caramel/" />

	<!-- Angular JS Spring REST api wrapper dependencies -->
	<script type="text/javascript"
			src="${springApiBasePath}api.js"></script>
	<script type="text/javascript"
			src="${springApiBasePath}apiWrapper.js"></script>
	<script type="text/javascript"
			src="${springApiBasePath}apiForm.js"></script>
	<script type="text/javascript"
			src="${springApiBasePath}apiDataTable.js"></script>
	<script type="text/javascript"
			src="${springApiBasePath}apiControllerTemplate.js"></script>
